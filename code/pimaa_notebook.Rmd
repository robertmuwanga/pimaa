...
* Add a date variable from the timestamp variable so that information can easily be views and analysed by date

* Convert the timestamp variable into lubridate format so that its easier to use in analysis.
...
if(all(pimaa[blank_noise_indexes, 'sensor_code'] == 'noise')) {
